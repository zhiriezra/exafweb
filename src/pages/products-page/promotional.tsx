          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            >
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                ...
                technology platform. Connect directly with farmers, optimize
                your supply chain, and scale your operations across Africa.
              </p>
              <motion.div
              ...
              >
                ...
                >
                  ...
                  <p className="text-gray-600">
                    Expand your market reach and boost sales through our network
                    of verified farmers and distributors.
                  </p>
                </motion.div>
                <motion.div
                  whileHover={{ scale: 1.05 }}
                ...
                >
                  ...
                  <p className="text-gray-600">
                    Streamline your procurement process and ensure consistent
              ...
              >
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="bg-[#1F6306] hover:bg-[#1F6306]/90 cursor-pointer text-white px-8 py-4 rounded-full text-lg font-semibold transition-colors"
                >
                  Get Started Today
                </motion.button>
              </Link>
